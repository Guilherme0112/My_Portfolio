        ...
        <section id="sobre">
            ...
            <div className="flex justify-center my-[20px]">
                <p className="w-full px-[50px]">
                    ...
                    Tenho facilidade para aprender e me adaptar a novas tecnologias, o que me ajuda a evoluir rapidamente em projetos e equipes. Estou sempre pronto para encarar novos desafios e crescer como desenvolvedor.
                </p>
            </div>
        </section>
